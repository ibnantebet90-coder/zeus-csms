-- ============================================================
--  ZEUS CSMS — Migration Script
--  Dari  : v0.4
--  Ke    : v0.5
--  Mode  : Recreate dari nol (dev/testing)
--
--  ⚠️  PERINGATAN: Script ini MENGHAPUS semua data!
--      Jalankan hanya di environment dev/testing.
--      Backup dulu jika perlu:
--        mysqldump -u root -p zeus_csms > zeus_csms_backup_v0.4.sql
-- ============================================================
...
-- ------------------------------------------------------------
-- STEP 1: Drop semua tabel v0.4 (urutan: child → parent)
-- ------------------------------------------------------------
DROP TABLE IF EXISTS charge_limit_requests;
DROP TABLE IF EXISTS charging_limit_config;
DROP TABLE IF EXISTS send_commands;
DROP TABLE IF EXISTS openadr_events;
DROP TABLE IF EXISTS tariffs;
DROP TABLE IF EXISTS energy_trafo;
...
-- Tabel baru di v0.5 (jaga-jaga jika sudah ada)
DROP TABLE IF EXISTS settings;

SET FOREIGN_KEY_CHECKS = 1;

-- ------------------------------------------------------------
-- STEP 2: Buat semua tabel v0.5
--         (salin dari zeus_csms_schema_v0.5.sql)
-- ------------------------------------------------------------
...
CREATE TABLE charge_limit_requests (
    id                  INT UNSIGNED    NOT NULL AUTO_INCREMENT,
...
-- ============================================================
-- SELESAI — database sekarang ada di v0.5
-- ============================================================